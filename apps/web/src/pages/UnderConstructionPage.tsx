    ...
    <section className="panel flex flex-col gap-4 p-5">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-[var(--text-muted)]">
          Ten ekran jest aktywny i gotowy pod kolejne etapy implementacji. Na tym etapie funkcja jest oznaczona jako W budowie.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-dashed border-[var(--outline-soft)] bg-white p-4">
        ...
        <p className="mt-2 text-sm text-[var(--text-muted)]">Następnie podmienimy ten placeholder na docelowy ekran modułu.</p>
      </div>
